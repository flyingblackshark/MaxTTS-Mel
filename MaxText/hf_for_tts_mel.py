...
if __name__ == "__main__":
    ...
    for item in multihost_gen:
        ...
        mel_arr  = jax.jit(get_mel, in_shardings=mel_x_sharding,out_shardings=x_sharding)(item["audio_44k"])
        @partial(jax.jit,in_shardings=(get_sharding_for_spec(PartitionSpec(None)),x_sharding),out_shardings=x_sharding)
        ...
        text_arr = jax.device_put(item["text"],x_sharding)
