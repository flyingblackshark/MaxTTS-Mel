...
disable_caching()
os.environ["HF_DATASETS_IN_MEMORY_MAX_SIZE"]=str(1024*1024*64)
...
class HFParseAudioFeatures(grain.MapTransform):
  ...
  def map(self, features):
    audio_44k = librosa.resample(features["audio"]["array"], orig_sr=SOURCE_SAMPLERATE, target_sr=44100,res_type="fft")
    audio_16k = librosa.resample(features["audio"]["array"], orig_sr=SOURCE_SAMPLERATE, target_sr=16000,res_type="fft")
    return {
