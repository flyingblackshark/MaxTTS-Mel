...
4. Install dependencies.
    ...
    ```
    python3 multihost_runner.py --TPU_PREFIX=node-6 --COMMAND="bash setup.sh" --INTERNAL_IP=true
    ```
...
5. Run your training job.
    ...
    python3 multihost_runner.py --TPU_PREFIX=node-1 --COMMAND="python3 MaxText/hf_for_tts_mel.py" --INTERNAL_IP=true
    ```
    If you are running the `multihost_runner.py` script from a TPUVM, you will need to set `--INTERNAL_IP=true`.
